import { createElement, useEffect as useEffect$1, useState as useState$1 } from 'react';
...
var useScrollSlide = function () {
    ...
    var _a = useState$1(false), isHidden = _a[0], setHidden = _a[1];
    var _b = useState$1(pos), prevPos = _b[0], setPrevPos = _b[1];
...
var Navbar = function (_a) {
    ...
    return (createElement("nav", { className: styles$3[navClassName], role: "navigation" },
        createElement(NavigationBrand, { route: "/", brand: brand }),
        shouldShowHamburger && (createElement(Hamburger, { isToggled: isToggled, onToggle: onHamburgerClick })),
